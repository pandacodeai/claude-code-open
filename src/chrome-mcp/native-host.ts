...
export const NATIVE_HOST_NAME = 'com.anthropic.axon_browser_extension';
...
export function getNativeHostsDirectory(): string | null {
  ...
  switch (platform) {
    ...
    case 'windows': {
      ...
      return path.join(appData, 'Axon', 'ChromeNativeHost');
    }
    case 'wsl':
    default:
      return null;
...
/**
 * 获取 Socket 路径
 * 复用官方的 pipe 名称，这样可以连接到官方 Chrome 扩展启动的 Native Host
 */
...
export function generateNativeHostManifest(wrapperScriptPath: string): object {
  return {
    ...
    description: 'Axon Browser Extension Native Host',
...
REM Generated by Axon - do not edit manually
${command}
`;
  }
...
# Generated by Axon - do not edit manually
exec ${command}
`;
}
